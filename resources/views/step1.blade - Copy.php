...
width: fit-content;padding:5px;">
			...
			<select id="account" class="select2">
			 	@if(isset($accounts))
		...
		<div style="width:fit-content;border: 2px solid blue;padding: 3px;">
			...
			<button class="refreshTable hide" style="color: white;background: green;">Refresh Table</button>
			<button class="executeIssue" style="color: black;background: yellow;">Execute (Issue)</button>
			<button class="executeSelected hide" style="color: white;background: blue;">Execute Selected</button>
			<button class="execAll" style="color: white;background: blue;">Execute All</button>
			<button class="removeSelected hide" style="color: white;background: red;">Remove Selected</button>
			<button class="removeAllBtn" style="color: white;background: red;">Remove All</button>
		</div>
		<div style="width:fit-content;border: 2px solid blue;">
			...
			$('#addRow').on('click', function(e){
				...
				if(validateAdd()){
					...
					let protoFlag = checkProtocols([
							...
							$('#users').val(), 
							$('#type').val(), 
							'<i class="fa fa-spinner fa-pulse fa-3x fa-fw" style="font-size:initial;"></i>',
							'loading',
						])
					if(protoFlag){
						table.row.add( [
